...
#define MMA865x_IIC_ADDRESS       0x3A // 7 Bit value = 0x1C

/***********************************************************************************************
**
**  MMA865xQ Sensor Internal Registers
*/
enum
{
  MMA865x_STATUS_00 = 0,          // 0x00 - MMA8652 only
  ...
  MMA865x_RSVD_0,                 // 0x07  
  MMA865x_RSVD_1,                 // 0x08  
  MMA865x_F_SETUP,                // 0x09 - MMA8652 only
  MMA865x_TRIG_CFG,               // 0x0A - MMA8652 only
  MMA865x_SYSMOD,                 // 0x0B
  MMA865x_INT_SOURCE,             // 0x0C
  MMA865x_WHO_AM_I,               // 0x0D
  MMA865x_XYZ_DATA_CFG,           // 0x0E
  MMA865x_HP_FILTER_CUTOFF,       // 0x0F - MMA8652 only
  MMA865x_PL_STATUS,              // 0x10
  MMA865x_PL_CFG,                 // 0x11
  MMA865x_PL_COUNT,               // 0x12
  MMA865x_PL_BF_ZCOMP,            // 0x13
  MMA865x_PL_P_L_THS_REG,         // 0x14
  ...
  MMA865x_RSVD_4,                 // 0x1B  
  MMA865x_RSVD_5,                 // 0x1C  
  MMA865x_TRANSIENT_CFG,          // 0x1D - MMA8652 only
  MMA865x_TRANSIENT_SRC,          // 0x1E - MMA8652 only
  MMA865x_TRANSIENT_THS,          // 0x1F - MMA8652 only
  MMA865x_TRANSIENT_COUNT,        // 0x20 - MMA8652 only
  MMA865x_PULSE_CFG,              // 0x21 - MMA8652 only
  MMA865x_PULSE_SRC,              // 0x22 - MMA8652 only
  MMA865x_PULSE_THSX,             // 0x23 - MMA8652 only
  MMA865x_PULSE_THSY,             // 0x24 - MMA8652 only
  MMA865x_PULSE_THSZ,             // 0x25 - MMA8652 only
  MMA865x_PULSE_TMLT,             // 0x26 - MMA8652 only
  MMA865x_PULSE_LTCY,             // 0x27 - MMA8652 only
  MMA865x_PULSE_WIND,             // 0x28 - MMA8652 only
